					...
					<div class="col-md-5 order-md-last wrap-about align-items-stretch">
						<div class="wrap-about-border ftco-animate">
							...
							<div class="text">
								...
								<ul><br>
								<p><a href="#" class="btn btn-primary py-3 px-4">Nous contacter</a></p>
							</div>
						</div>
					</div>
...
<!-- 				<div class="row no-gutters">
		...
		<!-- <section class="ftco-section ftco-no-pb">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-4">Nos récents projets/h2>
...
<!--     				<div class="py-md-5">
		          <div class="heading-section heading-section-white ftco-animate mb-5">
		            ...
		            <p>Remplissez le formulaire ci-dessous pour nous demander un devis</p>
		          </div>
		          <form action="#" class="appointment-form ftco-animate">
		                    ...
		                    <select name="" id="" class="form-control">
		                      ...
		                      <option value="">Affiche publicitaire</option>
		                      <option value="">Bâche</option>
		                      <option value="">Calendrier</option>
		                      <option value="">Carte d’invitation</option>
		                      <option value="">Carte d’invitation</option>
        ...
        <div class="row ftco-animate justify-content-center">
          <div class="col-md-12">
            <div class="carousel-testimony owl-carousel">
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img" style="background-image: url(images/avtar_wag.jpg)">
                  </div>
