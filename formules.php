...
<html lang="en">
   <?php include('include/header.php'); ?>
    <title>Nos formules | KP10 IS</title>
    <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Accueil <i class="ion-ios-arrow-forward"></i></a></span> <span>Formules <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>Parce que nous voulons participer à l’aventure des autres et apporter notre contribution à leur succès, nous avons conçu des formules pour aider</p>
				...
				<div class="row no-gutters">
					...
					<div class="col-md-3 d-flex">
						<div class="services-2 text-center ftco-animate" style="margin-top: 15px;">
