...
<script type="text/javascript">
    (function () {
        var options = {
            whatsapp: "+33 7 53 66 11 08", // WhatsApp number
...
<div class="sib-form" style="text-align: right;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div></div>
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:right; background-color:rgba(0,51,102,1); max-width:540px; border-radius:3px; border-width:0px; border-color:#C0CCD9; border-style:solid;">
      <form id="sib-form" method="POST" action="https://13011f67.sibforms.com/serve/MUIEAEkvtieX2sqn6tpHrm681K5Dx4eZwqJidwEG3OoraUhO95cYGRUZcXCTEilsecFn7PJ1uuA1MxFCcdSmrB3IvBEbHCqb9LnreBQ-6wtnz5PTn33gIH8jWN9sLb9FO6Kv7td7jdsa_eRb1CoVLFky2uVOQKVsdSGA6jpGPUVLCXSRCwFh5_-n5tHgeKFFBuuIs8fThycVG6Au"
          ...
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-size:16px; text-align:left;  font-family:&quot;Helvetica&quot;, sans-serif; color:#ffffff; border-width:px;" for="EMAIL" data-required="*">
                  Entrez votre EMAIL
                </label>
        ...
        <div style="padding: 16px 0;">
          <div class="sib-form-block" style="text-align: center">
            <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-size:12px; text-align:center; font-weight:700; font-family:&quot;Helvetica&quot;, sans-serif; color:#FFFFFF; background-color:#266fdd; border-radius:14px; border-width:0px;"
