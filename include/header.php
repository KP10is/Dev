  <head>
    ...
    <link rel="stylesheet" href="fonts/nunito/NunitoSans-Black.ttf" />
 ...
 <!--::header part start::-->
   <header class="main_menu">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item text-center p-4">
              <p>Ils ne savaient pas que c’était impossible, alors ils l’ont fait.<small> -Mark Twain</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>On ne naît pas vainqueur, on le devient. <small> -Inconnu</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>La motivation te sert de départ. L’habitude te fait continuer.<small> -Jim Ryun</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>Peu importe si le début paraît petit.<small> -Henri David Thoreau</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>La vie c’est 10% ce que vous faites et 90% votre façon de vous y prendre.<small> -Irving berlin</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>Réussir, c’est vivre sans regret.<small> -Brice Corne</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>Chaque pas doit être un but.<small> -Jacques Chirac</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>Si vous ne demandez pas, la réponse sera toujours non.<small> -Nora Roberts</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>Le succès c’est d’aller d’échec en échec sans perdre son enthousiasme.<small> -W.  Churchill</small></p>
            </div>
            <div class="carousel-item text-center p-4">
            ...
            <div class="carousel-item text-center p-4">
              <p>Il n'y a qu'une réponse à la défaite, et c'est la victoire.<small> -W. Churchill</small></p>
            </div>
            <div class="carousel-item text-center p-4">
            ...
            <div class="carousel-item text-center p-4">
              <p>Au diable les circonstances: je crée des opportunités.<small> -Bruce Lee</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>Tout ce qui peut être fait un jour, le peut être aujourd’hui.<small> -Inconnu</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>La fortune sourit aux audacieux.<small> -Virgile</small></p>
            </div>
            <div class="carousel-item text-center p-4">
              <p>La persévérance est un talisman pour la vie.<small> -Proverbe Africain</small></p>
            </div>
            <div class="carousel-item text-center p-4">
            ...
            <div class="carousel-item text-center p-4">
              <p>Les portes de l’avenir sont ouvertes à ceux qui savent les pousser.<small> -Coluche</small></p>
            </div>
            <div class="carousel-item text-center p-4">
