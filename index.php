...
<!--             <p><a href="services.php" class="btn btn-primary px-4 py-3 mt-3">Demandez un devis</a></p> -->
          </div>
        </div>
        </div>
      </div>
...
<!--             <p><a href="services.php" class="btn btn-primary px-4 py-3 mt-3">Demandez un devis</a></p> -->
				...
				<div class="row d-flex">
					<div class="col-md-5 order-md-last wrap-about align-items-stretch">
						<div class="wrap-about-border ftco-animate">
							...
							<div class="text">
								<h3 style="color: #ff6600;">Nos Valeurs Ajoutées</h3>
								<ul style="color: black;">
									<li>Augmentation du bénéfice de votre entreprise grâce à nos réductions.</li>
								 	<li>Une gestion allégée de vos prestataires (Seul, on couvre beaucoup).</li>
								 	<li>Un gain énorme en temps pour faire autre chose pour votre entreprise.</li>
								 	<li>Nous favorisons votre visibilité auprès des milliers de nos clients concernés.</li>
								 	<li>Vos salariés et vos clients sont aussi gagnants avec nous.</li>						 
								<ul><br>
								<p><a href="contact.php" class="btn btn-primary py-3 px-4">Nous contacter</a></p>
							</div>
						</div>
					</div>
    ...
    <section class="ftco-section">
          ...
          <div class="col-md-8 text-center heading-section ftco-animate">
            ...
            <p>Se découvrir, s’ouvrir pour couvrir les besoins informatiques et analytiques. Dans le cadre africain, nous prônons des solutions africaines aux problèmes africains.</p>
          </div>
        </div>
			</div>
		</section>
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img" style="background-image: url(images/p_3.jpg)">
                  </div>
                  <div class="text pl-4">
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img" style="background-image: url(images/p_4.jpg)">
                  </div>
                  <div class="text pl-4">
                  	<span class="quote d-flex align-items-center justify-content-center">
                      <i class=""></i>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img" style="background-image: url(images/p_5.jpg)">
                  </div>
                  <div class="text pl-4">
                  	<span class="quote d-flex align-items-center justify-content-center">
                      <i class=""></i>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img" style="background-image: url(images/p_1.jpg)">
                  </div>
                  <div class="text pl-4">
                  	<span class="quote d-flex align-items-center justify-content-center">
                      <i class=""></i>
              ...
              <div class="item">
                <div class="testimony-wrap d-flex">
                  <div class="user-img" style="background-image: url(images/p_2.jpg)">
                  </div>
                  <div class="text pl-4">
                  	<span class="quote d-flex align-items-center justify-content-center">
                      <i class=""></i>
                    ...
                    <span class="position">Gestionnaire Commercial</span>
                  </div>
                </div>
              </div>
              <div class="item">
